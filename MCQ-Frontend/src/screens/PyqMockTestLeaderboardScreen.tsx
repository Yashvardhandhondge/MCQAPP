...
import { getPyqMockTestLeaderboard } from '../services/mcq.service';
import type { LeaderboardEntry } from '../types/mcq';
import BackHeader from '../components/ui/BackHeader';
import { safeGoBack } from '../utils/navigation';

export type PyqMockTestLeaderboardScreenProps = NativeStackScreenProps<
  AppStackParamList,
  'PyqMockTestLeaderboard'
>;

export default function PyqMockTestLeaderboardScreen({
  route,
}: PyqMockTestLeaderboardScreenProps) {
  ...
  const headerTitle = year ? `${title} • ${year} Leaderboard` : `${title} Leaderboard`;
  ...
  useEffect(() => {
    ...
    async function fetchLeaderboard() {
      ...
      setError(null);
      try {
        const response = await getPyqMockTestLeaderboard(title, year);
        if (isMounted) {
        ...
        if (isMounted) {
          const message =
            requestError instanceof Error
              ...
              : 'Failed to load PYQ mock test leaderboard';
          setError(message);
          setLeaderboard([]);
        }
      } finally {
    ...
    return (
      <SafeAreaView edges={['top']} style={styles.safeArea}>
        <View style={styles.backgroundGradient}>
          <BackHeader title={headerTitle} navigation={navigation} />
  ...
  return (
    <SafeAreaView edges={['top']} style={styles.safeArea}>
      <View style={styles.backgroundGradient}>
        <BackHeader title={headerTitle} onBack={() => safeGoBack(navigation)} />
        <ScrollView
                ...
                return (
                  <View style={styles.emptyContainer}>
                    ...
                    <Text style={styles.emptySubtext}>
                      Complete this PYQ mock test to appear on the leaderboard!
                    </Text>
                  </View>
                );
              }
                      ...
                      >
                        <View style={styles.premiumPromptContent}>
                          ...
                          <View style={styles.premiumPromptTextContainer}>
                            <Text style={styles.premiumPromptTitle}>Purchase Premium</Text>
                            <Text style={styles.premiumPromptSubtitle}>
                              See your position with other students who took this paper
                            </Text>
                          </View>
                              ...
                              <View style={styles.entryContent}>
                                ...
                                <View style={styles.userInfo}>
                                  <View style={styles.userInfoContent}>
                                    ...
                                    <Text style={styles.userNameDefault} numberOfLines={1}>
                                      {entry.name}
                                    </Text>
                                  </View>
                                </View>
