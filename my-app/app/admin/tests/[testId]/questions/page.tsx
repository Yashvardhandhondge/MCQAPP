...
/** True when question can have an image: Add Image flag is yes/true/1 or any value, or image already set */
function isAddImageEnabled(q: PyqQuestion): boolean {
  const a = (q.addImage ?? '').toString().trim();
  const img = (q.image ?? '').toString().trim();
  return a.length > 0 || img.length > 0;
}
            ...
            <div className="p-6">
              ...
              <div className="mt-6 flex gap-3 justify-end">
                ...
                <button
                  ...
                  disabled={feeding || !subject || !chapter || !yearInput.trim()}
